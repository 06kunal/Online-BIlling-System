...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <div class="e-container">
        <h1>Select Your Mobile Recharge Plan Here.</h1>

        <form action="" , method="post">
            <div class="form">
                <label for="input bill id" style="color:black; font-size:large">Enter your Mobile number: </label>
                <input type="Text" name="Eid" id="e-id" placeholder="Enter phone number">
            </div>
            ...
            <div class="print-bill" >
                ...
                if (isset($_POST['submit-btn'])) {    ?>
                    ...
                    <table style="width: 500px;">
                        ...
                        <tr>
                            <td>1.</td>
                            <td>399 for 1.5GB/Day</td>
                            <td>1 month</td>
                        </tr>
                        <tr>
                            <td>2.</td>
                            <td>599 for 2GB/Day</td>
                            <td>1 month</td>
                        </tr>
                        <tr>
                            <td>3.</td>
                            <td>799 for 2.5GB/Day</td>
                            <td>1 month</td>
                        </tr>
                        <tr>
                            <td>4.</td>
                            <td>999 for 3GB/Day</td>
                            <td>1 month</td>
                        </tr>
                        <tr>
                            <td>5.</td>
                            <td>3999 for 1.5GB/Day</td>
                            <td>1 Year</td>
                        </tr>
                    </table>
