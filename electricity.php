...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <div class="e-container">
        <h1>Select Your Pre-Paid Electricity Plan Here.</h1>
            ...
            <div class="print-bill">
                ...
                if (isset($_POST['submit-btn'])) {    ?>
                    ...
                    <table style="width: 500px;">
                        ...
                        <tr>
                            <td>2.</td>
                            <td>599 for 200 units</td>
                            <td>1 month</td>
                        </tr>
                        <tr>
                            <td>3.</td>
                            <td>799 for 300 units</td>
                            <td>1 month</td>
                        </tr>
                        <tr>
                            <td>4.</td>
                            <td>999 for 400 units</td>
                            <td>1 month</td>
                        </tr>
                        <tr>
                            <td>5.</td>
                            <td>1100 for 500 units</td>
                            <td>1 month</td>
                        </tr>
